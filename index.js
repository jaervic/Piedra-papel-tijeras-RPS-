...
function mensajePerdedor() {
    const MENSAJES_PERDEDORES = ["No puede ser loquis", "NOOOOOOOO", "Lamentable", "Es en serio?", "Te has puesto a pensar qu..", "Lo importante es que tienes salud", "¿Sabes? Quizás esto no es lo tuyo", "F", "Super F", "Y si juegas Tetris mejor?", "Bueno...", "No te voy a pedir que te rindas pero al menos piensalo", "*canta* Y si hacemos un muñeco?", "Por esto tu ex no te quiere", "Es normal que pierdas tu dignidad así?", "Tus padres saben que estás perdiendo contra una PC?", "Me puedo reir de ti? Total ya todo el mundo lo hace", "¿Oiste eso? ¿No te llaman afuera?", "Cuando quieras te puedes ir... No te estoy corriendo.", "No te molestes pero... nada...", "Va a llegar un momento en el que no voy a saber que decirte y ese momento es... ahora.", "Ya no te quiero", "Si me ganas (que por lo que veo no vas a hacerlo) que piensas hacer después?"]
...
function mensajeEmpate() {
    const MENSAJES_EMPATE = ["Empataste, dale otra vez, si no eres un bobo dejame decirte", "Y si sales a buscar trabajo?", "Tú mamá debe estar preocupada por ti, deberías llamarla y decirle que estás jugando esto, a ver si se siente orgullosa.", "Ok, Empataste, estás bien?", "Estoy casi (14%) seguro que puedes decidir mejor", "Bueno... y entonces?", "Si te estás cansando de mi solo dilo", "Nada que ver aquí, sigue jugando", "...", "Cuanta paciencia tienes? Porque esto va para rato", "Para estar jugando aquí debes tener BASTANTE tiempo libre, no tienes hijos que cuidar?", "This what a mf do when has no p$ss&", "Mira... Empataste otra vez, que tal?", "Piensa en el retiro, en serio", "Hay cosas mejores que hacer ahora mismo, por ejemplo, pasar un coleto...", "Para pensar señores", "Puedes hacerlo mejor (jaja mentira)", "La idea es que aprendas a tomar decisiones, ok?, no que empates.", "Has oido del nuevo COVID-20 Pro Max S?", "Lamentable, muy muy lamentable...", "Sabes la razón por la que estás aquí?", "Empataste, y eso es... nefasto", "Como haces para ser así de Tomador-de-malas-decisiones?"]
